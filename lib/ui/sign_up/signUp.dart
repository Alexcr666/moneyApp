...
class _signUpPageState extends State<signUpPage> {
  ...
  bool isPasswordCompliant(String password, [int minLength = 8]) {
    ...
    print(hasDigits.toString() + hasUppercase.toString() +
        hasLowercase.toString() + hasSpecialCharacters.toString() +
...
return true;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      StoreProvider<AppStateSignUp>(
       //ReduxSignUp.store,
        store: ReduxSignUp.store,
        child:
        StoreConnector<AppStateSignUp, dynamic>(
            distinct: true,
                        ...
                        Column(
                          children: <Widget>[
                                  ...
                                  if (value
                                    ...
                                    if (value
                                        ...
                                        value
                                            .trim()
                                            .length <= 15) {
                                      if (_controllerRepeatPassword.text.toString() ==
                                          value.toString()) {
                                        if (isPasswordCompliant(
                                          ...
                                          return AppLocalizations.of(context).errorFormatPassword1;
                                        }
                                        // return null;
                                      } else {
                                        return AppLocalizations.of(context).errorFormatPassword2;
                                      }
                                    } else {
                                      return AppLocalizations.of(context).errorFormatPassword3;
                                    }
                                  }
                                },
                            ...
                            GestureDetector(
                                ...
                                child:
                                widgetButtonIcon(AppLocalizations.of(context).calculator, assetsCalculator)),
                            SizedBox(
                              height: 30,
                            ),
                            GestureDetector(
